...
export const serverUrl = "https://learning-management-system-cieq.onrender.com"
...
function App() {
  ...
  useEffect(() => {
    // Only fetch when token exists (user likely logged in)
    if (!token) return

    // Call your fetch functions. If those return promises, you can await them here.
    // If they internally dispatch to redux, this is fine.
    getCurrentUser()
    getCouseData()
    getCreatorCourseData()
    getAllReviews()

    // If any of those functions return an abort/cancel function, return it here for cleanup.
    // e.g. return () => controller.abort()
